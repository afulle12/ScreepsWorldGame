/**
 * marketLabReverse.js  --  thin shim around the consolidated marketLab module.
 *
 * The real implementation lives in marketLab.js. This file exists so that
 * existing `require('marketLabReverse')` calls (and profiler registrations
