...
module.exports = {
  init: function(deps) {
    ...
    global.orderTowerDrain = function(homeRoom, targetRoom, count) {
      ...
      var existingOrder = Memory.towerDrainOrders.find(function(o){ return o.targetRoom === targetRoom && o.homeRoom === homeRoom; });
      if (existingOrder) {
    ...
    global.cancelTowerDrainOrder = function(homeRoom, targetRoom) {
      ...
      var orderIndex = Memory.towerDrainOrders.findIndex(function(o){ return o.targetRoom === targetRoom && o.homeRoom === homeRoom; });
      if (orderIndex > -1) {
